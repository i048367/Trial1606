sap.ui.define([
	...
	return BaseController.extend("ns.controller.CreateEntity", {
		...
		_onCreate: function(oEvent) {
			...
			var oContext = this._oODataModel.createEntry("ProductSet", {
		...
		_fnEntityCreated: function(oData) {
			var sObjectPath = this.getModel().createKey("ProductSet", oData);
