sap.ui.define([
	...
	QUnit.test("Should always return a sorter when sorting", function(assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("Category").length, 1, "The sorting by Category returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by Category and there was a grouping before", function(assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("Category");
